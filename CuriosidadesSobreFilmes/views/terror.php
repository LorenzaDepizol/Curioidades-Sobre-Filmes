<?php include "cabecalho-terror.php" ?>
<body>
  <header>
            ...
            foreach($lista as $key => $value)
        {
          ...
          if($logado){
            ...
            if($IsFavorite)
            {
              ...
              $favorito = '<a href = "../controllers/userController.php?action=2&idFilme='.$id_filme.'&idUser='.$id_usuario.'" style = "top: 5px;" class="btn-floating halfway-fab waves-effect waves-light "><i class="material-icons" style = "background-color: #e53935">favorite</i></a>';
