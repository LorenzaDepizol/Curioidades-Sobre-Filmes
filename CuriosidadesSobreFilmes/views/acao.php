<?php include "cabecalho-acao.php" ?>
<body>
  <header>     
          <center><h1>AÇÃO</h1></center>
      ...
      <?php
        ...
        foreach($lista as $key => $value)
        {
          ...
          if($logado){
            ...
            $link_avaliar = "./view.php";
            $IsFavorite = "./view.php";
            $favorito = '<a href = "./view.php" style = "top: 2px;" class="btn-floating halfway-fab waves-effect waves-#274C5F "><i class="material-icons">favorite_border</i></a>';
