<?php include "cabecalho-ficcao.php" ?>
<body>
  <header>
         <center><h1>FICÇÃO</h1><center>        
  </header> 
  <?php
          ...
          foreach($lista as $key => $value)
        {
          ...
          if($logado){
            ...
            if($IsFavorite)
            {
              ...
              $favorito = '<a href = "../controllers/userController.php?action=1&idFilme='.$id_filme.'&idUser='.$id_usuario.'" style = "top: 5px;" class="btn-floating halfway-fab waves-effect waves-light "><i class="material-icons" style = "background-color: #512da8;">favorite_border</i></a>';
